...
$sourceSubscriptionId="cd400f31-6f94-40ab-863a-673192a3c0d0"

#Provide the name of your resource group where managed disk exists
$sourceResourceGroupName='LP4S1-Demo-Setup'

#Provide the name of the managed disk
$managedDiskName='win2k8_disk2_7402bc7f6c3b478bbddf4698139f8473'
...
$targetResourceGroupName='LP4S1-Storage-Migration'
